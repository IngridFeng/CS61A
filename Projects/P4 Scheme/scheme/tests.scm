...
(define (print_5) (print 5))
; expect print_5

(print_5)
; expect 5

(quote (6 . (8 cs61a is a nice course!)))
; expect (6 8 cs61a is a nice course!)
...
(begin (define x 3) (define y x) (modulo x y))
; expect 0

(lambda (x y) (modulo x y))
; expect (lambda (x y) (modulo x y))

(define func (lambda (x y) (modulo x y)))
; expect func
...
(mu () (modulo x y))
; expect (mu () (modulo x y))

(define f (mu () (modulo x y)))
; expect f

(define (func) (define x 3) (define y 5) (f))
; expect func
